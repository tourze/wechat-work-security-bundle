 ...
 * @internal
 */
#[CoversClass(ScreenOperateRecordCommand::class)]
#[RunTestsInSeparateProcesses]
final class ScreenOperateRecordCommandTest extends AbstractCommandTestCase
{
    ...
    {
        $command = self::getService(ScreenOperateRecordCommand::class);
        $this->assertInstanceOf(ScreenOperateRecordCommand::class, $command);
    ...
    {
        $command = self::getService(ScreenOperateRecordCommand::class);
        $this->assertSame('wechat-work:screen-operate-record', $command->getName());
        $this->assertSame('截屏/录屏管理', $command->getDescription());
    }
